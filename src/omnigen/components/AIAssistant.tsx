...
Click the link above to download your converted file.`);
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, x: -20 }}
      className="h-screen bg-[#030612] text-white flex flex-col overflow-hidden relative"
    >
      {/* Glow Orbs for Chitti Robo Theme */}
      <div className="absolute top-1/4 left-1/4 w-[350px] h-[350px] bg-purple-600/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-cyan-600/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="flex-1 flex overflow-hidden relative z-10">
        {/* Persistent History Sidebar */}
        <aside className={`fixed inset-y-0 left-0 z-50 border-r border-purple-500/10 bg-[#070b19]/95 backdrop-blur-xl transition-all duration-300 md:relative md:bg-[#070b19]/60 flex flex-col overflow-hidden ${showHistory
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              ...
              <div className="flex items-end gap-3">
                ...
                <div className="flex-1 relative group">
                  <div className="w-full bg-[#070b19]/90 border border-purple-500/15 rounded-2xl shadow-2xl backdrop-blur-3xl overflow-hidden focus-within:ring-2 focus-within:ring-purple-500/50 transition-all flex flex-col">
